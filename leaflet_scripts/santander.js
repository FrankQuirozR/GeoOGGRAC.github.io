...
//otro map
 let basemapUrl = 'http://mts2.google.com/vt/lyrs=y&x={x}&y={y}&z={z}'
...
L.control.polylineMeasure({position:'topleft', unit:'metros', clearMeasurementsOnStop: false, showMeasurementsClearControl: true, showUnitControl: true, showAreaMeasurement: true}).addTo(map);
